...
export function AddDelayActionPanel(){
    return(
        <UiEntity
        key={resources.slug + "action::delay::actions::panel"}
        uiTransform={{
    ...
    >
        ...
        uiText={{value:"Delay Time", textAlign:'middle-left', fontSize:sizeFont(20,15)}}
        />
...
export function Row(info:any){
    ...
    return(
        <UiEntity
        key={resources.slug + "delay-action-row-"+ info.rowCount}
            uiTransform={{
                flexDirection: 'row',
                alignItems: 'center',
                justifyContent: 'center',
