...
export function resetCloneEntity(){
    engine.removeEntity(setPositionEntity)
}

export function addCloneEntity(){
...
export function updateCloneEntity(direction:string, factor:number, manual?:boolean){
...
export function AddClonePanel(){
    return(
        <UiEntity
        key={resources.slug + "action::clone::panel"}
        uiTransform={{
