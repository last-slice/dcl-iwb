...
export let showSceneSavedPanel = false

export function displaySceneSavedPanel(value: boolean) {
    showSceneSavedPanel = value
}

export function createSceneSavedPanel() {
    return (
        <UiEntity
            key={"scenesavedpanel"}
            uiTransform={{
                display: showSceneSavedPanel ? 'flex' : 'none',
