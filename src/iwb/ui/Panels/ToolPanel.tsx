...
import {customSelect, itemSelect, objName} from './CatalogPanel'
import {engine, Entity, MeshCollider, MeshRenderer, Transform} from '@dcl/ecs'
import {getPlayerPosition} from '@dcl-sdk/utils'
import {dimensions} from '../helpers'
import {createObject} from "../../helpers/selectedObject";
import {getFrontOfPlayerPosition} from "../../helpers/functions";
            ...
            <Button
                ...
                onMouseDown={() => {
                    ...
                    if (itemSelect && customSelect) {
                        ...
                        console.log("front of player" + JSON.stringify(getFrontOfPlayerPosition()))
                        createObject(objName,{x: 0, y: -.88, z: 4},Vector3.create(1,1,1))
