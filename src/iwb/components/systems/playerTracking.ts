...
export function PlayerTrackingSystem(dt: number) {
    ...
    if (selectedItem && selectedItem.entity && localPlayer.mode === SCENE_MODES.BUILD_MODE) {
    ...
    console.log('moved')
    const otherAvatarTransform = Transform.getMutable(godBox)
