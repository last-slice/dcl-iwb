...
import {updateAudio, updateAudioAttach, updateAudioLoop, updateAudioUrl} from "../../scenes/components";//
...
export function audioComponentListener(asset: any) {
    if (asset.audComp) {
        asset.audComp.listen("url", (currentValue: any, previousValue: any) => {
            ...
            updateAudioUrl(asset.aid, asset.id, asset.matComp, currentValue)
        });
